...
$sublinks = [
  ...
  'items' => [
    [
      'title' => 'Date',
      'link' => '/calendar' . '?sort=date&' . ($filter_val ? 'filter=' . $filter_val : 'filter=all'),
      'active' => $sort_val == 'date'
    ],
    [
      'title' => 'Title',
      'link' => '/calendar' . '?sort=title&' . ($filter_val ? 'filter=' . $filter_val : 'filter=all'),
  ...
  'filters' => [
    [
      'title' => 'All',
      'link' => '/calendar?' . ($sort_val ? 'sort=' . $sort_val : 'sort=date') . '&filter=all',
      'active' => $filter_val == 'all'
    ],
    [
      'title' => 'Exhibition',
      'link' => '/calendar?' . ($sort_val ? 'sort=' . $sort_val : 'sort=date') . '&filter=exhibition',
      'active' => $filter_val == 'exhibition'
    ],
    [
      'title' => 'Event',
      'link' => '/calendar?' . ($sort_val ? 'sort=' . $sort_val : 'sort=date') . '&filter=event',
...
// $all_upcoming = Timber::get_posts( array(
//   'post_type' => $filterby,
//   'posts_per_page' => -1,
